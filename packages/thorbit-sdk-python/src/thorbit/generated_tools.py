...
class ThorbitAccountBillingGetPlanOutputResult(BaseModel):
    ...
    limits: dict[str, str] = Field(description="Named metrics with a maximum serialized size of 500000 bytes.")
    usage: dict[str, str]
...
class ThorbitTopicMapStartInput(BaseModel):
    ...
    maxCompetitorUrls: (int) | None = Field(default=35, description="Maximum URLs per competitor to inspect.", ge=1, le=100)
